...
//ol.proj.get("EPSG:3857").setExtent([-1822333.229479, 3628874.003893, 839543.501242, 5457809.233636]);
var wms_layers = [];


        var lyr_EsriTopographyMap_0 = new ol.layer.Tile({
            'title': 'EsriTopographyMap',
            'type':'base',
            'opacity': 1.000000,
